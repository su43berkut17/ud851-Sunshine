...
//  COMPLETED (16) Create a String array containing the names of the desired data columns from our ContentProvider
    public static final String[] FIELD_NAMES={WeatherContract.WeatherEntry.COLUMN_DATE,
                   WeatherContract.WeatherEntry.COLUMN_MAX_TEMP,
                   WeatherContract.WeatherEntry.COLUMN_MIN_TEMP,
                   WeatherContract.WeatherEntry.COLUMN_WEATHER_ID,};

//  COMPLETED (17) Create constant int values representing each column name's position above
    public final static int INDEX_WEATHER_DATE=0;
    public final static int INDEX_WEATHER_CONDITION_ID=3;
    public final static int INDEX_WEATHER_MAX_TEMP=1;
    public final static int INDEX_WEATHER_MIN_TEMP=2;
