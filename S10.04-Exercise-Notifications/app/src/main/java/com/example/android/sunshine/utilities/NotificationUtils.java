...
//  COMPLETED (1) Create a constant int value to identify the notification
    public static final int NOTIF_ID=703;
...
//          COMPLETED (3) Create an Intent with the proper URI to start the DetailActivity
            Intent weatherUriIntent=new Intent(context, DetailActivity.class);
            weatherUriIntent.setData(todaysWeatherUri);

//          COMPLETED (4) Use TaskStackBuilder to create the proper PendingIntent
            TaskStackBuilder taskStackBuilder=TaskStackBuilder.create(context);
            taskStackBuilder.addNextIntentWithParentStack(weatherUriIntent);
            PendingIntent resultIntent=taskStackBuilder.getPendingIntent(0,PendingIntent.FLAG_UPDATE_CURRENT);
