...
//  COMPLETED (10) Add constant values to sync Sunshine every 3 - 4 hours
    ...
    private static final int NUMBER_OF_SECONDS=(int) TimeUnit.HOURS.toSeconds(NUMBER_OF_HOURS);
    private static final int SECONDS_FLEX_TIME=NUMBER_OF_SECONDS;
...
//  COMPLETED (12) Create a method to schedule our periodic weather sync
    synchronized public static void scheduleWeather(@NonNull final Context context){
        ...
        Job weatherJob = dispatcher.newJobBuilder()
                ...
                .setRecurring(true)
                .setTrigger(Trigger.executionWindow(NUMBER_OF_SECONDS*3,SECONDS_FLEX_TIME*3+NUMBER_OF_SECONDS))
                .setReplaceCurrent(true)
                .build();

        dispatcher.schedule(weatherJob);
    }
