...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData(){
        ...
        URL builder=NetworkUtils.buildUrl(location);

        new asyncLoad().execute(builder);
    }

    // COMPLETED (5) Create a class that extends AsyncTask to perform network requests
    private class asyncLoad extends AsyncTask<URL, Void, String>{
        ...
        protected String doInBackground(URL... urls) {
            ...
            try{
                returnedString= NetworkUtils.getResponseFromHttpUrl(urlSend);
            }catch (IOException e){
                e.printStackTrace();
            }
